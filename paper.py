...
def main_train(nunit, seed, incomplete_set=False):
    ...
    Args:
        incomplete_set : if True, do not train 'delayanti' and 'contextdelaydm1'
    '''
    ...
    if incomplete_set:
        ...
        rule_trains = [[r for r in rules_dict[ruleset] if r not in rule_excludes]]
...
def cont_train(c, ksi, seed, save_name, seq=True):
    ...
    Args:
        ...
        seq : sequential or not
    '''
    from train import train
    param_intsyn = (c, ksi) # (c, ksi)
    ...
    if seq:
        # Sequential training
        rule_trains = ['fdgo', 'delaygo', 'dm1', 'dm2', ('contextdm1','contextdm2'), 'multidm',
                       'delaydm1', 'delaydm2', ('contextdelaydm1', 'contextdelaydm2'), 'multidelaydm']
    else:
        rule_trains = [('fdgo', 'delaygo', 'dm1', 'dm2', 'contextdm1','contextdm2', 'multidm',
                       'delaydm1', 'delaydm2', 'contextdelaydm1', 'contextdelaydm2', 'multidelaydm')]

    rule_tests = ['fdgo', 'delaygo', 'dm1', 'dm2', 'contextdm1', 'contextdm2', 'multidm',
                   'delaydm1', 'delaydm2', 'contextdelaydm1', 'contextdelaydm2', 'multidelaydm']
...
if __name__ == '__main__':
    ...
    for setup in setups:
        pass 
        # taskset.plot_taskspace_group(save_pattern, setup=setup, restore=True, representation='rate')
        # taskset.plot_taskspace_group(save_pattern, setup=setup, restore=True, representation='weight')
        # taskset.plot_replacerule_performance_group(save_pattern, setup=setup, restore=True)
